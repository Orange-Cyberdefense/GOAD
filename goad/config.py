...
class Config:
    ...
    def create_config_file(self):
        ...
        config.set('proxmox', 'pm_network_bridge_jump', 'vmbr0')
        config.set('proxmox', 'pm_network_model', 'e1000')
        config.set('proxmox', 'pm_dns_server', '1.1.1.1')
        config.set('proxmox', 'pm_jumpbox_public_ip', '192.168.1.100')
        config.set('proxmox', 'pm_jumpbox_public_ip_netmask', '/24')
        config.set('proxmox', 'pm_jumpbox_gateway', '192.168.1.1')
        ...
        config.set('proxmox_templates_id', 'ubuntu_jumpbox', '106')
