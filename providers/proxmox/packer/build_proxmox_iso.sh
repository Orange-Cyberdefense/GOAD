...
echo "[+] update windows_server2016_proxmox_cloudinit.json"
sed -i "s/\"sha256:.*\"/\"sha256:$sha_winserv2016\"/g" windows_server2016_proxmox_cloudinit.json
...
echo "[+] update windows_server2019_proxmox_cloudinit.json"
sed -i "s/\"sha256:.*\"/\"sha256:$sha_winserv2019\"/g" windows_server2019_proxmox_cloudinit.json
