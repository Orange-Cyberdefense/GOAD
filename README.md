...
- Installation depend of the provider you use, please follow the appropriate guide :
  ...
  - [Install with Сloud.ru](./docs/install_with_cloudru.md)
...
ad/
  labname/            # The lab name must be the same as the variable : domain_name from the data/inventory
    ...
    providers/        # Your lab available provider
      ...
      cloudru/
        terraform/    # specific cloudru terraform recipe
        inventory     # specific cloudru inventory

terraform/            # place for reusable terraform recipes
  cloudru/            # specific cloudru reusable terraform recipe
```
